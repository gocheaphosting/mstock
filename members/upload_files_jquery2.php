...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            'script_url' => surl.site_root.'/members/upload_files_jquery.php',
            'upload_dir' => $_SERVER["DOCUMENT_ROOT"].site_root."/content/".$tmp_folder."/",
            'upload_url' => surl.site_root."/content/".$tmp_folder."/",
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
