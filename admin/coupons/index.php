...
<a class="btn btn-success toright" href="new.php"><i class="icon-certificate icon-white fa fa-bookmark-o"></i> <?=word_lang("coupons")?></a>
...
<td><a href="content.php?id=<?=$rs->row["id_parent"]?>"><?=$rs->row["coupon_code"]?></a></td>
