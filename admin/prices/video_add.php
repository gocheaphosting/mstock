...
$sql="insert into video_types (types,price,priority,thesame,title,license,shipped) values ('".result($_POST["types"])."',".(float)$_POST["price"].",".(int)$_POST["priority"].",".(int)$_POST["thesame"].",'".result($_POST["title"])."',".(int)$_POST["license"].",".$shipped.")";
$db->execute($sql);
