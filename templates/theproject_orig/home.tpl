						...
						<div class="slider-banner-fullscreen">
							<ul class="slides">
								...
								<div class="tp-caption sft fadeout text-center large_white"
									...
									data-easing="easeOutQuad"
									data-start="6400"
									data-end="10000">Photo Video Store script
								</div>	
								...
								<div class="tp-caption sft fadeout medium_white text-center"
									...
									data-start="5800"
									data-end="10000"
									data-endspeed="600">The Project Bootstrap Theme
								</div>
								...
								<div class="tp-caption sfb fadeout large_white"
									...
									data-start="1000"
									data-easing="easeOutQuad"
									data-end="10000">The best way to sell your photos and prints online
								</div>	
								...
								<div class="tp-caption sfb fadeout text-left medium_white"
									...
									data-start="1300"
									data-easing="easeOutQuad"
									data-endspeed="600"><span class="icon default-bg circle small hidden-xs"><i class="fa fa-user"></i></span> Register as photographer
								</div>
								...
								<div class="tp-caption sfb fadeout text-left medium_white"
									...
									data-start="1600"
									data-easing="easeOutQuad"
									data-endspeed="600"><span class="icon default-bg circle small hidden-xs"><i class="fa fa-upload"></i></span> Upload your photos
								</div>
								...
								<div class="tp-caption sfb fadeout text-left medium_white"
									...
									data-start="1900"
									data-easing="easeOutQuad"
									data-endspeed="600"><span class="icon default-bg circle small hidden-xs"><i class="fa fa-trophy"></i></span> Earn commission
								</div>
								...
								<div class="tp-caption sfb fadeout text-left medium_white"
									...
									data-start="2200"
									data-easing="easeOutQuad"
									data-endspeed="600"><span class="icon default-bg circle small hidden-xs"><i class="fa fa-location-arrow"></i></span> Take a flight to Miami
								</div>
								...
								<div class="tp-caption sfb fadeout small_white"
									...
									data-start="2500"
									data-easing="easeOutQuad"
									data-endspeed="600"><a href="{SITE_ROOT}members/signup.php" class="btn btn-default btn-lg btn-animated">{lang.Signup} <i class="fa fa-user"></i></a>
								</div>
								</li>
								<!-- slide 2 end -->
							</ul>
				...
				<div class="container">
					<div class="row">
						<div class="main col-md-12">
							<h1 class="page-title text-center">Photo Stock</h1>
								...
								<div class="col-md-3">
									<div class="footer-content">
										...
										<ul class="social-links circle animated-effect-1">
											...
											<li class="googleplus"><a target="_blank" href="{GOOGLE}"><i class="fa fa-google-plus"></i></a></li>
										</ul>
										<div class="separator-2"></div>
										<ul class="list-icons">
				...
				<div class="subfooter">
					<div class="container">
						<div class="subfooter-inner">
							<div class="row">
								<div class="col-md-12">
									<p class="text-center">Copyright &copy; 2015 <a href="http://www.cmsaccount.com/">Photo Video Store</a> - {lang.All rights reserved}</p>
								</div>
							</div>
						</div>
					</div>
